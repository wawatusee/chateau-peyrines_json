<section id="accueil">
    <H1>Château Peyrines</H1>
    <h2>Accueil</h2> 
    <p>Présentation des produits et services de Chateau Peyrines.</p>
    <section>
        ...
        <div class="presentation">
            <a href="?page=catalogue" class="lien"><img class="picto-lien" src="/public/img/picto-bouteille.png" alt="dessin de bouteille de vin">Catalogue</a><span>Le catalogue présente tous les vins de Château-Peyrines que vous pouvez commander : vin blanc sec, vin rouge supérieur, vin moelleux, bulles de Peyrines, vin rosé.
